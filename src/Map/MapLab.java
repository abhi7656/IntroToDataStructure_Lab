...
public class MapLab {
    ...
    public static void main(String[] args) {
        ...
        // ========== SECTION 4: Accessing Frequencies ==========
        ...
        System.out.println(
                "   Frequency of '" + searchWord + "': " + javaCount
        );

        System.out.println(
                "   Frequency of 'unknown': " + unknownCount
        );
        ...
        System.out.println(
                "5. Checking if map contains specific keys and values..."
        );
        ...
        /*
         * The starter comment says to update "fun",
         * but the output displays "applications".
         * Therefore, applications is updated here.
         */
        ...
        // ========== SECTION 8: Finding Most and Least Frequent ==========
        System.out.println(
                "8. Finding most and least frequent words..."
        );
        ...
        System.out.println(
                "   All unique words: " + wordFrequency.keySet()
        );

        System.out.println(
                "   All frequency values: " + wordFrequency.values()
        );
