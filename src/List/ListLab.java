...
public class ListLab {
    ...
    public static void main(String[] args) {
        ...
        // Four additional tasks
        todoList.add("Complete Java lab");
        ...
        System.out.println(
                "   Does list contain '" + searchTask + "'? " + containsTask
        );

        System.out.println(
                "   Index of '" + searchTask + "': " + taskIndex
        );

        System.out.println();

        // ========== SECTION 6: Completing Tasks ==========
        ...
        System.out.println(
                "   Successfully removed 'Walk the dog': " + removed
        );
        ...
        System.out.println(
                "   Total remaining tasks: " + todoList.size()
        );

        System.out.println(
                "   Is list empty: " + todoList.isEmpty()
        );
